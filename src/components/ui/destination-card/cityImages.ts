...
export const citySpecificImages: Record<string, string[]> = {
  ...
  "Munich": [
    "https://images.unsplash.com/photo-1595867818082-083862f3d630?q=80&w=1470&auto=format&fit=crop",
  ...
  // Belgium
  "Brussels": [
    "https://images.unsplash.com/photo-1559113513-d5e09c78b9dd?q=80&w=1470&auto=format&fit=crop",
  ...
  "Bruges": [
    "https://images.unsplash.com/photo-1491557345352-5929e343eb89?q=80&w=1470&auto=format&fit=crop",
  ...
  // Netherlands
  "Amsterdam": [
    "https://images.unsplash.com/photo-1534351590666-13e3e96b5017?q=80&w=1470&auto=format&fit=crop",
  ...
  "Rotterdam": [
    "https://images.unsplash.com/photo-1541089801-5b7a0e4a2b68?q=80&w=1470&auto=format&fit=crop",
  ...
  // Russia
  "Moscow": [
    "https://images.unsplash.com/photo-1520106212299-d99c443e4568?q=80&w=1470&auto=format&fit=crop",
  ...
  "St. Petersburg": [
    "https://images.unsplash.com/photo-1556610961-2fecc5927173?q=80&w=1470&auto=format&fit=crop",
  ...
  // Italy
  "Milan": [
    "https://images.unsplash.com/photo-1520440229-6469a149ac59?q=80&w=1470&auto=format&fit=crop",
  ...
  "Naples": [
    "https://images.unsplash.com/photo-1517006487751-b9d5fd48fad4?q=80&w=1470&auto=format&fit=crop",
  ...
  "Palermo": [
    "https://images.unsplash.com/photo-1523365280197-f1183defb1fd?q=80&w=1470&auto=format&fit=crop",
  ...
  "Geneva": [
    "https://images.unsplash.com/photo-1573108724029-4c46571d6490?q=80&w=1470&auto=format&fit=crop",
  ...
  // Croatia
  "Dubrovnik": [
    "https://images.unsplash.com/photo-1555990793-da11153b2473?q=80&w=1470&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1591378603223-e15b45a81640?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1592866597689-35b8b42c95a5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Vienna": [
    "https://images.unsplash.com/photo-1573599852326-2d4da0bbe613?q=80&w=1470&auto=format&fit=crop", 
    "https://images.unsplash.com/photo-1579434183888-8aa852cd30f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1573599953681-801602b157e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Mexico City": [
    "https://images.unsplash.com/photo-1583292650898-7d22cd27ca6f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1518659526054-190340b35735?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1609706368808-86e1bfa89563?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Istanbul": [
    "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?q=80&w=1471&auto=format&fit=crop",
  ...
  "Cape Town": [
    "https://images.unsplash.com/photo-1586892478377-bb77355bd465?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1515452203560-3e67c49ef221?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1610641818989-127863698aa0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Marrakech": [
    "https://images.unsplash.com/photo-1618987990643-f545b7fac061?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1597212720281-158131cc8d7f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1554701261-4f29a12b3a75?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Rome": [
    "https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=1470&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1525874684015-58379d421a52?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1515542622106-78bda8ba0e5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Paris": [
    "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=1473&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
  ...
  "London": [
    ...
    "https://images.unsplash.com/photo-1486299267070-83823f5448dd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1471&q=80",
    "https://images.unsplash.com/photo-1520986606214-8b456906c813?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Barcelona": [
    "https://images.unsplash.com/photo-1539037116277-4db20889f2d4?q=80&w=1470&auto=format&fit=crop",
  ...
  "Prague": [
    "https://images.unsplash.com/photo-1592906209472-a36b1f3782ef?q=80&w=1470&auto=format&fit=crop",
  ...
  "Venice": [
    "https://images.unsplash.com/photo-1523906921802-b5d2d899e93b?q=80&w=1470&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?ixlib=rb-4.0.3&auto=format&fit=crop&w=1472&q=80",
    "https://images.unsplash.com/photo-1529154036614-a60975f5c760?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Florence": [
    "https://images.unsplash.com/photo-1543429243-1116bc1b8276?q=80&w=1470&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1541370976299-4d7cbc161195?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1527166458728-a3d46dbe1236?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Bali": [
    "https://images.unsplash.com/photo-1537996194471-e657df975ab4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1577717903308-a52dba7a29c1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1480&q=80",
    "https://images.unsplash.com/photo-1539367628448-4bc5c9d171c8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Tokyo": [
    "https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?ixlib=rb-4.0.3&auto=format&fit=crop&w=1336&q=80",
    "https://images.unsplash.com/photo-1503899036084-c55cdd92da26?ixlib=rb-4.0.3&auto=format&fit=crop&w=1471&q=80",
    "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1587&q=80"
  ],
  "Kyoto": [
    "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1558862107-d49ef2a04d72?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1493780474015-ba834fd0ce2f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Santorini": [
    "https://images.unsplash.com/photo-1570077188670-e3a8d3c6071d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1374&q=80",
    "https://images.unsplash.com/photo-1561845730-208ad5910553?ixlib=rb-4.0.3&auto=format&fit=crop&w=1035&q=80",
    "https://images.unsplash.com/photo-1601144741699-1d8f0a1edd24?ixlib=rb-4.0.3&auto=format&fit=crop&w=1035&q=80"
  ],
  "Machu Picchu": [
    "https://images.unsplash.com/photo-1526392060635-9d6019884377?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1548545565737-22411d10dffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1569324017145-fe036e892d6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "New York City": [
  ...
  "Sydney": [
    ...
    "https://images.unsplash.com/photo-1590716209211-ea74d5e9e0a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1548548614-9ddbdf72f692?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Rio de Janeiro": [
  ...
  "Dubai": [
    ...
    "https://images.unsplash.com/photo-1577471488278-16eec37ffcc2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
  ],
  "Bangkok": [
    "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1439&q=80",
    "https://images.unsplash.com/photo-1563492065599-3520f775eeed?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    "https://images.unsplash.com/photo-1588854337115-1c67d9247e4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1374&q=80"
  ]
};
